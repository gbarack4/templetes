  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-slate-50">
      <header className="flex shrink-0 items-center justify-between px-5 pb-2 pt-5">
        <DrivingSchoolProfile school={school} className="bg-transparent px-0 py-0" />
        <Link
          href="/login"
      ...
      <main className="flex min-h-0 flex-1 flex-col px-5 pb-6 pt-4">
        ...
        <div className="mt-3 flex items-center justify-center gap-2">
          ...
          <p className="text-sm text-slate-500">
            <span className="font-semibold text-slate-700">{googleReviews.rating}</span>{" "}
        ...
        <section className="mt-6 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
          <div className="flex items-center gap-2 border-b border-slate-100 pb-4">
            ...
            <h2 className="text-base font-bold text-slate-900">Find an instructor</h2>
          </div>

          <form className="mt-5 space-y-5" onSubmit={handleSearch}>
            <div className="space-y-2">
              <label htmlFor="pickup-suburb" className="text-sm font-semibold text-slate-900">
            ...
            <div className="space-y-2">
              <label htmlFor="transmission" className="text-sm font-semibold text-slate-900">
            ...
            <div className="space-y-2">
              <div>
                <label htmlFor="test-date" className="text-sm font-semibold text-slate-900">
                  Test pre-booked?
                </label>
                <p className="text-xs text-slate-400">Optional, helps match availability</p>
              </div>
              <div className="relative">
                ...
                >
                  <span className={selectedTestDate ? "text-slate-900" : "text-slate-400"}>
        ...
        <p className="mt-auto pt-6 text-center text-xs leading-relaxed text-slate-500">
          ...
          , you agree to our{" "}
          <a href="#" className="font-medium text-slate-700 underline underline-offset-2 hover:text-slate-900">
            terms
          </a>
          .
        </p>
